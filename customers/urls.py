...
urlpatterns = [
    ...
    path('suppliers/', supplier_list_view, name='supplierlist'),
    path('suppliers/page/<int:page>/', supplier_list_view, name='supplierlist'),
    path('suppliers/<int:pk>/', supplier_detail_view, name='supplierdetails'),
    path("suppliers/add/", supplier_add_view, name="supplier-add"),
