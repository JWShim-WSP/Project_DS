...
urlpatterns = [
    ...
    path('<int:pk>/', customer_detail_view, name='customerdetails'),
    path("add/", customer_add_view, name="customer-add"),
    path("<int:pk>/delete/", customer_delete_view, name="customer-delete"),
]