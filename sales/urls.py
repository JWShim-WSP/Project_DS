...
from .views import sales_dashboard_view, SaleListView, SaleDetailView, sales_list_view, sales_detail_view, positions_list_view, position_detail_view, sales_add_view, sales_delete_view, position_add_view, position_delete_view 
...
urlpatterns = [
    ...
    path('', sales_list_view, name='saleslist'),
    path('dashboard/', sales_dashboard_view, name='dashboard'),
